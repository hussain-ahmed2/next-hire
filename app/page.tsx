...
export default function Home() {
	return (
		<div className="flex-1 flex flex-col">
			<section className="min-h-[calc(100vh-8rem)] flex items-center justify-between gap-4 md:gap-8 relative py-8">
				<div className="w-full max-md:text-center md:w-1/2">
					...
					<h1 className="text-4xl md:text-6xl font-black mb-10 text-purple-900">Find Your Next Dream Job</h1>
			...
			<section className="min-h-96 flex flex-col items-center justify-center text-center py-8">
				<div>
			...
			<section className="min-h-[calc(100vh-8rem)] flex items-center justify-between gap-4 md:gap-8 relative py-8">
				<div className="max-md:absolute top-0 left-0 inset-0 max-md:-z-10 max-md:opacity-75 md:w-1/2">
					<Image className="w-full h-full" src="/job-hunt.svg" alt="hero" width={1000} height={1000} />
				</div>
				<div className="w-full max-md:text-center md:w-1/2">
					<h2 className="text-3xl md:text-5xl font-black mb-8 text-purple-900">We Build Lasting Relationships Between Candidates & Businesses</h2>
					<p className="max-w-3xl text-lg md:text-xl font-medium text-neutral-700 mb-6">
						The automated process starts as soon as your clothes go into the machine. The outcome is gleaming clothes. Placeholder text commonly used.
					</p>
					<p className="max-w-3xl text-lg md:text-xl font-medium text-neutral-700">
